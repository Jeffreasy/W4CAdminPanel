...
;// CONCATENATED MODULE: ./node_modules/next/dist/build/webpack/loaders/next-middleware-loader.js?absolutePagePath=private-next-root-dir%2Fsrc%2Fmiddleware.ts&page=%2Fsrc%2Fmiddleware&rootDir=C%3A%5CUsers%5Cjeffrey%5CDesktop%5CMAIN%20WHISKY%5CW4CAdminPanel&matchers=W3sicmVnZXhwIjoiXig%2FOlxcLyhfbmV4dFxcL2RhdGFcXC9bXi9dezEsfSkpPyg%2FOlxcLyhcXC8%2FaW5kZXh8XFwvP2luZGV4XFwuanNvbikpP1tcXC8jXFw%2FXT8kIiwib3JpZ2luYWxTb3VyY2UiOiIvIn0seyJyZWdleHAiOiJeKD86XFwvKF9uZXh0XFwvZGF0YVxcL1teL117MSx9KSk%2FXFwvbG9naW4oLmpzb24pP1tcXC8jXFw%2FXT8kIiwib3JpZ2luYWxTb3VyY2UiOiIvbG9naW4ifSx7InJlZ2V4cCI6Il4oPzpcXC8oX25leHRcXC9kYXRhXFwvW14vXXsxLH0pKT9cXC9kYXNoYm9hcmQoPzpcXC8oKD86W15cXC8jXFw%2FXSs%2FKSg%2FOlxcLyg%2FOlteXFwvI1xcP10rPykpKikpPyguanNvbik%2FW1xcLyNcXD9dPyQiLCJvcmlnaW5hbFNvdXJjZSI6Ii9kYXNoYm9hcmQvOnBhdGgqIn1d&preferredRegion=&middlewareConfig=eyJtYXRjaGVycyI6W3sicmVnZXhwIjoiXig%2FOlxcLyhfbmV4dFxcL2RhdGFcXC9bXi9dezEsfSkpPyg%2FOlxcLyhcXC8%2FaW5kZXh8XFwvP2luZGV4XFwuanNvbikpP1tcXC8jXFw%2FXT8kIiwib3JpZ2luYWxTb3VyY2UiOiIvIn0seyJyZWdleHAiOiJeKD86XFwvKF9uZXh0XFwvZGF0YVxcL1teL117MSx9KSk%2FXFwvbG9naW4oLmpzb24pP1tcXC8jXFw%2FXT8kIiwib3JpZ2luYWxTb3VyY2UiOiIvbG9naW4ifSx7InJlZ2V4cCI6Il4oPzpcXC8oX25leHRcXC9kYXRhXFwvW14vXXsxLH0pKT9cXC9kYXNoYm9hcmQoPzpcXC8oKD86W15cXC8jXFw%2FXSs%2FKSg%2FOlxcLyg%2FOlteXFwvI1xcP10rPykpKikpPyguanNvbik%2FW1xcLyNcXD9dPyQiLCJvcmlnaW5hbFNvdXJjZSI6Ii9kYXNoYm9hcmQvOnBhdGgqIn1dfQ%3D%3D!
...
var supabase;
function createClientComponentClient({ supabaseUrl = "https://nebeqoemxugdswapnvrk.supabase.co", supabaseKey = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im5lYmVxb2VteHVnZHN3YXBudnJrIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MzQ4MzMzODEsImV4cCI6MjA1MDQwOTM4MX0.DS8rGU2xvIM2dWR-McidZ_EKUweNTV2QgfE2jl3tOJ4", options, cookieOptions, isSingleton = true } = {}) {
...
function createPagesServerClient(context, { supabaseUrl = "https://nebeqoemxugdswapnvrk.supabase.co", supabaseKey = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im5lYmVxb2VteHVnZHN3YXBudnJrIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MzQ4MzMzODEsImV4cCI6MjA1MDQwOTM4MX0.DS8rGU2xvIM2dWR-McidZ_EKUweNTV2QgfE2jl3tOJ4", options, cookieOptions } = {}) {
    var _a;
    if (!supabaseUrl || !supabaseKey) {
        throw new Error("either NEXT_PUBLIC_SUPABASE_URL and NEXT_PUBLIC_SUPABASE_ANON_KEY env variables or supabaseUrl and supabaseKey are required!");
    }
...
function createMiddlewareClient(context, { supabaseUrl = "https://nebeqoemxugdswapnvrk.supabase.co", supabaseKey = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im5lYmVxb2VteHVnZHN3YXBudnJrIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MzQ4MzMzODEsImV4cCI6MjA1MDQwOTM4MX0.DS8rGU2xvIM2dWR-McidZ_EKUweNTV2QgfE2jl3tOJ4", options, cookieOptions } = {}) {
    var _a;
    if (!supabaseUrl || !supabaseKey) {
        throw new Error("either NEXT_PUBLIC_SUPABASE_URL and NEXT_PUBLIC_SUPABASE_ANON_KEY env variables or supabaseUrl and supabaseKey are required!");
    }
...
function createServerComponentClient(context, { supabaseUrl = "https://nebeqoemxugdswapnvrk.supabase.co", supabaseKey = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im5lYmVxb2VteHVnZHN3YXBudnJrIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MzQ4MzMzODEsImV4cCI6MjA1MDQwOTM4MX0.DS8rGU2xvIM2dWR-McidZ_EKUweNTV2QgfE2jl3tOJ4", options, cookieOptions } = {}) {
    var _a;
    if (!supabaseUrl || !supabaseKey) {
        throw new Error("either NEXT_PUBLIC_SUPABASE_URL and NEXT_PUBLIC_SUPABASE_ANON_KEY env variables or supabaseUrl and supabaseKey are required!");
    }
...
function createRouteHandlerClient(context, { supabaseUrl = "https://nebeqoemxugdswapnvrk.supabase.co", supabaseKey = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im5lYmVxb2VteHVnZHN3YXBudnJrIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MzQ4MzMzODEsImV4cCI6MjA1MDQwOTM4MX0.DS8rGU2xvIM2dWR-McidZ_EKUweNTV2QgfE2jl3tOJ4", options, cookieOptions } = {}) {
    var _a;
    if (!supabaseUrl || !supabaseKey) {
        throw new Error("either NEXT_PUBLIC_SUPABASE_URL and NEXT_PUBLIC_SUPABASE_ANON_KEY env variables or supabaseUrl and supabaseKey are required!");
    }
...
// src/deprecated.ts
function createBrowserSupabaseClient({ supabaseUrl = "https://nebeqoemxugdswapnvrk.supabase.co", supabaseKey = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im5lYmVxb2VteHVnZHN3YXBudnJrIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MzQ4MzMzODEsImV4cCI6MjA1MDQwOTM4MX0.DS8rGU2xvIM2dWR-McidZ_EKUweNTV2QgfE2jl3tOJ4", options, cookieOptions } = {}) {
...
function createServerSupabaseClient(context, { supabaseUrl = "https://nebeqoemxugdswapnvrk.supabase.co", supabaseKey = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im5lYmVxb2VteHVnZHN3YXBudnJrIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MzQ4MzMzODEsImV4cCI6MjA1MDQwOTM4MX0.DS8rGU2xvIM2dWR-McidZ_EKUweNTV2QgfE2jl3tOJ4", options, cookieOptions } = {}) {
...
function createMiddlewareSupabaseClient(context, { supabaseUrl = "https://nebeqoemxugdswapnvrk.supabase.co", supabaseKey = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im5lYmVxb2VteHVnZHN3YXBudnJrIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MzQ4MzMzODEsImV4cCI6MjA1MDQwOTM4MX0.DS8rGU2xvIM2dWR-McidZ_EKUweNTV2QgfE2jl3tOJ4", options, cookieOptions } = {}) {
