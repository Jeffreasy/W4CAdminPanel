...
export default function ContentManagement() {
  ...
  async function fetchSections() {
    try {
      ...
      const errorMessage = err instanceof Error ? err.message : 'Failed to fetch text sections'
  ...
  if (loading) return <LoadingSpinner size="large" message="Loading content..." centered />
              ...
              <div className="space-y-4">
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    onClick={() => {
                      const newContent = (document.getElementById(`edit-${section.id}`) as HTMLTextAreaElement).value
